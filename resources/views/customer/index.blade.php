...
<div class="wrapper" id="wrapper">
    ...
    <!-- End Search Popup -->
    <!-- Start Slider area -->
    <div class="slider-area brown__nav slider--1 slide__activation slide__arrow01 owl-carousel owl-theme">
        <!-- Start Single Slide -->
                    ...
                    <div class="col-lg-12">
                        <div class="slider__content">
                            <div class="contentbox">
                                ...
                                <h2>favourite <span>Software</span></h2>
        ...
        <div class="container">
            ...
            <div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb">
                            <a class="first__img" href="single-product.html"><img src="{{ asset('assets/images/books/burner.jpeg') }}" alt="product image"></a>
                            <a class="second__img animation1" href="/singleproduct"><img src="{{ asset('assets/images/books/burner.jpg') }}" alt="product image"></a>
                            <div class="hot__box">
                                <span class="hot-label">BEST SALLER</span>
                            </div>
                        </div>
                        <div class="product__content content--center">
                            <h4><a href="single-product.html">CD Burner</a></h4>
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb">
                            <a class="first__img" href="single-product.html"><img src="{{ asset('assets/images/books/antivsmart.jpeg') }}" alt="product image"></a>
                        ...
                        <div class="product__content content--center">
                            <h4><a href="single-product.html">Antivirus</a></h4>
                            <ul class="prize d-flex">
                                <li>$35.00</li>
                                <li class="old_prize">$35.00</li>
                            </ul>
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb">
                            <a class="first__img" href="single-product.html"><img src="{{ asset('assets/images/books/audio.jpg') }}" alt="product image"></a>
                        ...
                        <div class="product__content content--center">
                            <h4><a href="single-product.html">Image, VIdeo & Audio</a></h4>
                            <ul class="prize d-flex">
                                <li>$40.00</li>
                                <li class="old_prize">$35.00</li>
                            </ul>
                ...
                <div class="product product__style--3">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product__thumb">
                            <a class="first__img" href="single-product.html"><img src="{{ ('assets/images/books/loho.jpeg') }}" alt="product image"></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section__title text-center">
                        ...
                        <p>There are many variations of softwares that you can find from our site and they are genuine and come with warrant</p>
                    </div>
                </div>
            </div>
            <div class="row mt--50">
